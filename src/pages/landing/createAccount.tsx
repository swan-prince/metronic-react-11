...
const CreateAccount: FC<Props> = (props) => {
  ...
  const [teamSize, setTeamSize] = useState('1-1');
  const [accountPlan, setAccountPlan] = useState('company');

  const [saveCard, setSaveCard] = useState(true);

  return (
    <Modal id='kt_modal_create_account' tabIndex={-1} aria-hidden='true'
    ...
    >
      <div className="modal-content">
        <div className="modal-header header-bg" style={{ backgroundImage: 'url(media/misc/header-bg.png)' }}>
          <h2 className="text-white">Create Account
            <small className="ms-2 fs-7 fw-normal text-white opacity-50">Become a member and start earning</small></h2>
        ...
        <div className="modal-body scroll-y m-5">
          <div className="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
            <div className="stepper-nav py-5">
              <div className={clsx("stepper-item", { 'current': tab === 1 })} data-kt-stepper-element="nav">
                <h3 className="stepper-title">Account Type</h3>
              </div>
              <div className={clsx("stepper-item", { 'current': tab === 2 })} data-kt-stepper-element="nav">
                <h3 className="stepper-title">Account Info</h3>
              </div>
              <div className={clsx("stepper-item", { 'current': tab === 3 })} data-kt-stepper-element="nav">
                <h3 className="stepper-title">Business Details</h3>
              </div>
              <div className={clsx("stepper-item", { 'current': tab === 4 })} data-kt-stepper-element="nav">
                <h3 className="stepper-title">Billing Details</h3>
              </div>
              <div className={clsx("stepper-item", { 'current': tab === 5 })} data-kt-stepper-element="nav">
                <h3 className="stepper-title">Completed</h3>
              </div>
            </div>
            <form className="mx-auto mw-600px w-100 py-10" noValidate id="kt_create_account_form">
                  ...
                  <div className="fv-row">
                    <div className="row">
                      <div className="col-lg-6">
                        <input type="radio" className="btn-check" name="account_type" value="personal" checked={accountType === '1'} />
                        <label className="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center mb-10" onClick={() => setAccountType('1')}>
                      ...
                      <div className="col-lg-6">
                        <input type="radio" className="btn-check" name="account_type" value="corporate" checked={accountType === '2'} />
                        <label className="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center" onClick={() => setAccountType('2')}>
                          <span className="svg-icon svg-icon-3x me-5">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="w-100">
                  ...
                  <div className="mb-10 fv-row">
                    ...
                    <div className="row mb-2" data-kt-buttons="true">
                      <div className="col">
                        <label
                          className={clsx("btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4", { 'active': teamSize === '1-1' })}
                          onClick={() => setTeamSize('1-1')}
                        >
                      ...
                      <div className="col">
                        <label
                          className={clsx("btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4", { 'active': teamSize === '2-10' })}
                          onClick={() => setTeamSize('2-10')}
                        >
                          <input type="radio" className="btn-check" name="account_team_size" checked={teamSize === '2-10'} value="2-10" />
                          <span className="fw-bold fs-3">2-10</span>
                        </label>
                      </div>
                      <div className="col">
                        <label
                          className={clsx("btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4", { 'active': teamSize === '10-50' })}
                      ...
                      <div className="col">
                        <label
                          className={clsx("btn btn-outline btn-outline-dashed btn-active-light-primary w-100 p-4", { 'active': teamSize === '50+' })}
                    ...
                    <div className="mb-0">
                      <label className="d-flex flex-stack mb-5 cursor-pointer">
                        ...
                        <span className="form-check form-check-custom form-check-solid">
                          <input className="form-check-input" type="radio" onClick={() => setAccountPlan('company')} checked={accountPlan === 'company'} name="account_plan" value="1" />
                        </span>
                      </label>
                      <label className="d-flex flex-stack mb-5 cursor-pointer">
                        <span className="d-flex align-items-center me-2">
                        ...
                        <span className="form-check form-check-custom form-check-solid">
                          <input className="form-check-input" type="radio" onClick={() => setAccountPlan('developer')} checked={accountPlan === 'developer'} name="account_plan" value="2" />
                        </span>
                      </label>
                      <label className="d-flex flex-stack mb-0 cursor-pointer">
                        ...
                        <span className="form-check form-check-custom form-check-solid">
                          <input className="form-check-input" type="radio" name="account_plan" onClick={() => setAccountPlan('testing')} checked={accountPlan === 'testing'} value="3" />
                        </span>
                      </label>
                    </div>
                  </div>
                ...
                <div className="w-100">
                  ...
                  <div className="d-flex flex-stack">
                    ...
                    <label className="form-check form-switch form-check-custom form-check-solid">
                      <input className="form-check-input" type="checkbox" value="1" checked={saveCard} onChange={(e) => setSaveCard(e.target.checked)} />
                ...
                <div className="w-100">
                  <div className="pb-8 pb-lg-10">
                    ...
                    <div className="text-muted fw-semibold fs-6">If you need more info, please
                      <a href="../../demo10/dist/authentication/layouts/corporate/sign-in.html" className="link-primary fw-bold">Sign In</a>.</div>
                  </div>
                  <div className="mb-0">
                      ...
                      <div className="d-flex flex-stack flex-grow-1">
                        <div className="fw-semibold">
                          ...
                          <div className="fs-6 text-gray-700">To start using great tools, please,
                            <a href="../../demo10/dist/utilities/wizards/vertical.html" className="fw-bold">Create Team Platform</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className={clsx("d-flex flex-stack pt-15")}>
                <div className="mr-2">
                  {
                    tab > 1 && (
                      <button type="button" className="btn btn-lg btn-light-primary me-3" onClick={() => setTab(tab - 1)}>
                ...
                <div>
                  ...
                  {
                    tab < 5 && (
                      <button type="button" className="btn btn-lg btn-primary" data-kt-stepper-action="next" onClick={() => setTab(tab + 1)}>
                        Continue
